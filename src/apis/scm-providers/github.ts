...
export class GitHubProvider extends Utils {
    ...
    */
    public async updateTUFMirror(gitOrg: string, gitRepository: string, tufURL: string): Promise<string | undefined> {
        return await this.commitInGitHub(gitOrg, gitRepository, 'rhtap/env.sh',  "http://tuf.rhtap-tas.svc", tufURL,  "Update TUF mirror in environment file");
    }
    ...
    public async updateRekorHost(gitOrg: string, gitRepository: string, rekorHost: string): Promise<string | undefined> {
        return await this.commitInGitHub(gitOrg, gitRepository, 'rhtap/env.sh', "http://rekor-server.rhtap-tas.svc", rekorHost, "Update rekor URL in environment file");
    }
